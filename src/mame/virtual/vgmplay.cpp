...
void vgmplay_state::vgmplay(machine_config &config)
{
	...
	m_ym2608[0]->add_route(0, m_viz, 0.25, 0);
	m_ym2608[0]->add_route(0, m_viz, 0.25, 1);
	...
	m_ym2608[1]->add_route(0, m_viz, 0.25, 0);
	m_ym2608[1]->add_route(0, m_viz, 0.25, 1);
	...
	m_ym2610[0]->add_route(0, m_viz, 0.25, 0);
	m_ym2610[0]->add_route(0, m_viz, 0.25, 1);
	...
	m_ym2610[1]->add_route(0, m_viz, 0.25, 0);
	m_ym2610[1]->add_route(0, m_viz, 0.25, 1);
