...
void chloe_state::chloe(machine_config &config)
{
	...
	*/
	...
	AY8912(config, m_ay[0], 28_MHz_XTAL / 16)
		...
		.add_route(2, "speaker", 0.25, 0)
		.add_route(2, "speaker", 0.25, 1)
		.add_route(1, "speaker", 0.50, 1);
	...
	DAC_8BIT_R2R(config, m_covox, 0)
		.add_route(ALL_OUTPUTS, "speaker", 0.75, 0)
		.add_route(ALL_OUTPUTS, "speaker", 0.75, 1);
