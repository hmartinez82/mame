...
void sprinter_state::sprinter(machine_config &config)
{
	...
	ay8910.add_route(0, "speaker", 0.50, 0);
	ay8910.add_route(1, "speaker", 0.25, 0);
	ay8910.add_route(1, "speaker", 0.25, 1);
	ay8910.add_route(2, "speaker", 0.50, 1);

	DAC_16BIT_R2R(config, m_ldac, 0).add_route(ALL_OUTPUTS, "speaker", 0.5, 0);
	DAC_16BIT_R2R(config, m_rdac, 0).add_route(ALL_OUTPUTS, "speaker", 0.5, 1);
