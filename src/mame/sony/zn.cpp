...
public:
	...
	void coh1000ta(machine_config &config) ATTR_COLD
	{
		...
		m_ym2610b->add_route(0, m_speaker, 0.25, 0);
		m_ym2610b->add_route(0, m_speaker, 0.25, 1);
...
ROM_START( cbaj )
	...
	ROM_LOAD( "cb-03.219",         0x1000000, 0x400000, BAD_DUMP CRC(3576ea2a) SHA1(a5ee7bb9f4650e99ee067eb1cc28c62d9099a6cf) ) // see cbajbl
	ROM_LOAD( "cb-04.220",         0x1400000, 0x400000, BAD_DUMP CRC(551c4b29) SHA1(c3f8508a006b475491c9ea20eb64c3bea6b35afb) ) // see cbajbl
